...
const socialLinks = [
  ...
  {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/ganesh-s-b8629a281?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
  ...
  {
      name: 'Instagram',
      url: 'https://www.instagram.com/savage_codee?igsh=YW5zN2l6cnU3cmZl',
  ...
  {
    name: 'YouTube',
    url: 'https://youtube.com/@apm_explorers',
    icon: 'M19.615 3.184C21.403 3.61 22.607 5.02 22.87 6.846c.348 2.418.348 7.453.348 7.453s0 5.035-.348 7.453c-.263 1.826-1.467 3.237-3.255 3.662C17.317 25 12 25 12 25s-5.318 0-7.615-.586c-1.788-.425-2.992-1.836-3.255-3.662C.782 18.334.782 13.299.782 13.299s0-5.035.348-7.453c.263-1.826 1.467-3.237 3.255-3.662C6.682 2 12 2 12 2s5.317 0 7.615.586zm-8.71 5.703v8.225l7.025-4.113-7.025-4.112z',
    color: '#FF0000'
  }
